...
interface ILetsVault {
    ...
    event StrategyReported(
        address indexed strategy, uint256 gain, uint256 loss, uint256 totalDebt, uint256 protocolFees
    );
    ...
    function initialize(address asset_, string memory name_, string memory symbol_, address manager_) external;
