...
contract LetsVaultTest is Test {
    ...
    event StrategyReported(
        address indexed strategy, uint256 gain, uint256 loss, uint256 currentDebt, uint256 protocolFee
    );
    ...
    function setUp() public {
        ...
        // Initialize vault
        vault.initialize(address(underlying), "Test Vault", "vTEST", manager);
