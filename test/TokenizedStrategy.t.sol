...
contract MockStrategy is TokenizedStrategy {
    ...
    constructor(address _asset, address _vault, address _feeRecipient)
        TokenizedStrategy(_asset, "Mock Strategy", "mSTRAT", _vault, _feeRecipient)
    {
        currentAssets = 0;
    }
...
contract TokenizedStrategyTest is Test {
    ...
    function setUp() public {
        ...
        strategy = new MockStrategy(address(asset), vault, feeRecipient);
    ...
    function testFail_InitializeZeroAsset() public {
        new MockStrategy(address(0), vault, feeRecipient);
    }
